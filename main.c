...
static void activate (GtkApplication *app,gpointer user_data) {
    ...
    gtk_grid_attach(GTK_GRID(gridParent),numbut6,0,2,1,1);

    //init of numbut5
    GtkWidget *numbut5 = gtk_button_new_with_label("5");
    gtk_grid_attach(GTK_GRID(gridParent),numbut5,1,2,1,1);

    //init of numbut4
    GtkWidget *numbut4 = gtk_button_new_with_label("4");
    gtk_grid_attach(GTK_GRID(gridParent),numbut4,2,2,1,1);

    //init of numbut1
    GtkWidget *numbut1 = gtk_button_new_with_label("1");
    gtk_grid_attach(GTK_GRID(gridParent),numbut1,0,3,1,1);

    //init of numbut2
    GtkWidget *numbut2 = gtk_button_new_with_label("2");
    gtk_grid_attach(GTK_GRID(gridParent),numbut2,1,3,1,1);

    //init of numbut3
    GtkWidget *numbut3 = gtk_button_new_with_label("3");
    gtk_grid_attach(GTK_GRID(gridParent),numbut3,2,3,1,1);

    //init of numbut0
    GtkWidget *numbut0 = gtk_button_new_with_label("0");
    gtk_grid_attach(GTK_GRID(gridParent),numbut0,1,4,1,1);
